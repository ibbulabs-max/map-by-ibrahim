...
import { Map, Settings, User, ShieldCheck, Users, Home } from "lucide-react";
...
function itemsFor(isAdmin: boolean, isSupervisor: boolean): NavItem[] {
  if (isAdmin) return [MAP, HOUSES, ADMIN, TEAM, SETTINGS, PROFILE];
  if (isSupervisor) return [MAP, HOUSES, TEAM, SETTINGS, PROFILE];
  return [MAP, HOUSES, SETTINGS, PROFILE];
}
